...
public class M3M1 {
  ...
  public M3M1 (String straatNaam, int huisNummer, String bus, int postCode, String woonPlaats){
    ...
    public String getbus(String bus) {  //getter straal
        return this.bus;
    }
    ...
    public int getpostCode(int postCode) {  //getter straal
    ...
    public void print() {
        System.out.println("straat naam: " + this.straatNaam);
        System.out.println("huis nummer: " + this.huisNummer);
